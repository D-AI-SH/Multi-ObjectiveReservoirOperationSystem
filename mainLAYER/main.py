...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self._header_color_default = "#2b6cb0"
        self._header_color_running = "#d97706"  # 橙色

        self.header_bar = QWidget()
        self.header_bar.setObjectName("HeaderBar")
        self.header_bar.setStyleSheet(
            f"#HeaderBar { { } }".replace("{ }", f"{{ background-color: {self._header_color_default}; }}")
            + "#HeaderBar QLabel#HeaderTitle { color: white; font-weight: 600; }"
            + "#HeaderBar QPushButton { background: transparent; color: white; border: 1px solid rgba(255,255,255,0.25);"
            + " border-radius: 4px; padding: 4px 10px; }"
            + "#HeaderBar QPushButton:hover { background: rgba(255,255,255,0.12); }"
            + "#HeaderBar QPushButton:pressed { background: rgba(255,255,255,0.2); }"
        )
...
class ExportConfigDialog(QDialog):
    ...
    def init_ui(self):
        ...
        title_label.setStyleSheet("font-weight: bold; font-size: 14px; margin: 10px; color: #ffffff;")
        ...
        preview_label.setStyleSheet("font-weight: bold; margin-top: 20px; color: #ffffff;")
        ...
        preview_text.setStyleSheet("background-color: #404040; color: #ffffff; padding: 10px; border: 1px solid #555555; border-radius: 4px;")
...
if __name__ == "__main__":
    ...
    splash.showMessage("系统启动中...", Qt.AlignmentFlag.AlignBottom | Qt.AlignmentFlag.AlignCenter, Qt.GlobalColor.white)
    splash.show()
    app.processEvents()
