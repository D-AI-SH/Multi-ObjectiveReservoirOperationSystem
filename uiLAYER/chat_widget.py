...
class ChatWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.btn_collapse.setStyleSheet(
            "QPushButton { background-color: #000000; color: #ffffff; border: 1px solid #222222;"
        ...
        self.api_combo.setStyleSheet(
            "QComboBox { background-color: #333333; color: #dddddd; border: 1px solid #555555; border-radius: 4px; padding: 2px 6px; }"
            "QComboBox:hover { background-color: #444444; }"
            "QComboBox::drop-down { border: none; }"
            "QComboBox::down-arrow { image: none; border-left: 5px solid transparent; border-right: 5px solid transparent; border-top: 5px solid #dddddd; }"
        )
        ...
        self.btn_settings.setStyleSheet(
            "QPushButton { background-color: #444444; color: #dddddd; border: 1px solid #555555; border-radius: 4px; padding: 2px 6px; }"
        ...
        self.input_edit.setStyleSheet(
            "QLineEdit { background-color: #333333; color: #eeeeee; border: 1px solid #555555; border-radius: 4px; padding: 4px; }"
        ...
        self.send_btn.setStyleSheet(
            "QPushButton { background-color: #4a6fa5; color: white; border: none; border-radius: 4px; padding: 4px 12px; }"
            "QPushButton:hover { background-color: #608ccd; }"
            "QPushButton:pressed { background-color: #3b5c85; }"
        )
        ...
        self.thinking_label.setStyleSheet(
            "QLabel { color: #9aa0a6; padding: 2px 0; }"
        )
