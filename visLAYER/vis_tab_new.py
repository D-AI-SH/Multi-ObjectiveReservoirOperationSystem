...
class VisTab(QWidget):
    ...
    def show_empty_message(self):
        ...
        empty_label.setStyleSheet("font-size: 16px; color: gray; margin: 50px;")
        # 设置中文字体
    ...
    def create_field_chart(self, field_name):
        ...
        frame.setStyleSheet("QFrame { border: 1px solid #ccc; margin: 5px; padding: 10px; background: white; }")
        
        layout = QVBoxLayout(frame)
        
        # 添加标题
        title_label = QLabel(f"字段：{field_name}")
        title_label.setStyleSheet("font-size: 16px; font-weight: bold; color: #333; margin: 5px;")
